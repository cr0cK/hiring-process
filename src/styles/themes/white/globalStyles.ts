...
// Import tenable design system css tokens
import '@tenable/design-system.styles/css-tokens.css'
...
const GlobalStyle = createGlobalStyle<IGlobalStyleProps>(props => {
  return (
    buildVariants(props)
      ...
      /**
       * Show TUL when being authenticated.
       */
      .variant('isAuthenticated', props.isAuthenticated, {
        false: {
        ...
        true: {
          ...
          '#app': {
            height: `calc(100% - ${themes.white.constants.tenableTulHeight}px)`
          }
        }
      })
